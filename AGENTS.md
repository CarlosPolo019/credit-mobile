...
- UI: patron `challenge-blossom` con colores Blossom, `className`, `lucide-react-native`, bottom sheets y listas compactas.
...
## Definition Of Done
- Registro/login por cedula restaura y limpia sesion correctamente.
