 ...
 * treated as a flat MONTHLY rate (matches how this product's forms use it,
 * e.g. "2" means 2% per month) — not annual. Same formula as
 * `credit-web/lib/creditPayment.js`, kept for parity between the operator
 * app and the admin web.
 *
 ...
 */
export function estimateCreditPayment({ amount, interestRate, termMonths }: PaymentInput): PaymentEstimate {
